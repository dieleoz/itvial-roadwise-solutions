...
const categories: SolutionCategory[] = [
  ...
  },
  {
    ...
    description: "Infraestructura de carga para vehículos eléctricos y soluciones de energía sostenible para la transición energética del transporte.",
    products: [
      { name: "Cargadores para Vehículos Eléctricos (AC/DC)", icon: BatteryCharging },
      ...
      { name: "Iluminación LED Solar", icon: Lightbulb },
    ],
  },
  {
    id: "delineadores",
    ...
    icon: ShieldAlert,
    description: "Dispositivos de canalización y delineación vial flexibles para seguridad activa en carreteras y zonas urbanas.",
    products: [
  ...
  },
  {
    ...
    icon: ShieldAlert,
    description: "Sistemas certificados de protección vehicular para zonas de trabajo que salvan vidas en carreteras y autopistas.",
    products: [
      { name: "Atenuador de Impacto Remolcable", icon: Truck },
      { name: "Atenuador Montado en Vehículo (TMA)", icon: CarFront },
    ],
  },
];
